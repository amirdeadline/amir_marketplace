---
name: amir-prisma-scm-api
description: >-
  pan.dev SCM & SASE APIs: TSG service accounts, OAuth2, pagination, config-as-code, curl/Python examples. Use when the user asks about SCM / SASE APIs in Prisma SASE / SCM. (amir marketplace).
