---
name: amir-prisma-sdwan
description: >-
  ION onboarding, path policy, app SLAs, branch topologies, interop with Prisma Access. Use when the user asks about Prisma SD-WAN in Prisma SASE / SCM. (amir marketplace).
