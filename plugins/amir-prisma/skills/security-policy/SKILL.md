---
name: amir-prisma-security-policy
description: >-
  Security rules, profiles/profile groups, decryption, App-ID/User-ID in SASE, best-practice rulebase design and ordering. Use when the user asks about Security Policy in Prisma SASE / SCM. (amir marketplace).
