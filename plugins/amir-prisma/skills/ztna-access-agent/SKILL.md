---
name: amir-prisma-ztna-access-agent
description: >-
  Prisma Access Agent / ZTNA constructs and private app access patterns. Use when the user asks about ZTNA / Access Agent in Prisma SASE / SCM. (amir marketplace).
