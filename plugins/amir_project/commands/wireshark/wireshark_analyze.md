---
description: Protocol hierarchy / conversations / expert on a file.
---
...
# /amir:wireshark_analyze

`python "${CLAUDE_PLUGIN_ROOT}/scripts/wireshark/tshark_cli.py" analyze -- $ARGUMENTS`
