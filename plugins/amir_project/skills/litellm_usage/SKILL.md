...
description: >-
  ...
  model. Use for cheap bulk/classification, second opinions, spend checks, and (amir marketplace).
...
```powershell
python "${CLAUDE_PLUGIN_ROOT}/scripts/litellm/litellm_claude.py"
# or
${CLAUDE_PLUGIN_ROOT}/scripts/litellm/litellm-claude.cmd --model <override> -- <claude args>
```
