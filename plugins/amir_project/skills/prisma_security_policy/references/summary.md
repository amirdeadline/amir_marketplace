# prisma_security_policy — baked reference summary
...
- topic: 7. Path / QoS(priority) / Performance / NGFW security policy — source: `ai_prisma_sdwan.md`#7-path-qos-priority-performance-ngfw-security-policy (line 143)
...
- topic: Source PDF: advanced-url-filtering-administration — source: `prisma_access.md`#advanced-url-filtering-administration (line 52)
- Source PDFs (sample):
