...
name: adem
description: >-
  ADEM tests, agent-based visibility, experience scores, symptom → segment → root-cause methodology. Use when the user asks about Autonomous DEM in Prisma SASE / SCM.
