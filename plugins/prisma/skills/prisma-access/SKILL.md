...
name: prisma-access
description: >-
  Mobile Users (GlobalProtect + Explicit Proxy), Remote Networks, Service Connections, locations/compute regions, egress IP, autoscaling. Use when the user asks about Prisma Access in Prisma SASE / SCM.
