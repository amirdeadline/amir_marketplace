...
name: scm-platform
description: >-
  Strata Cloud Manager tenancy/folders/snippets, configuration scope, config push, variables, RBAC, licensing, onboarding, dashboards. Use when the user asks about SCM Platform in Prisma SASE / SCM.
